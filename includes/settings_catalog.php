...
function settingsCatalogKeywords(): array {
    return [
        ...
        'wl_probe_required'      => 'submission must prove itself fetch metadata seeders before registering',
        'wl_probe_timeout_minutes' => 'how long a submission has to prove itself timeout',
        'wl_probe_on_fail'       => 'what happens to a submission that failed the probe delete keep',
        'wl_probe_max_batch'     => 'how many submissions probe at once per submission batch',
