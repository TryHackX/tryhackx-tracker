...
function settingsCatalogGroups(): array {
    return [
        ...
        ['id' => 'network',      'title' => 'Network & limits',   'icon' => 'bi-speedometer2',
         'keywords' => 'database mariadb mysql memory ram buffer pool innodb firewall nftables rate limit throttle udp packets pps traffic flood inbound outbound egress budget trusted exempt kernel buffers rmem wmem sysctl backlog stability probe tuner'],
